...
class AnimateController:
    ...
    def animate(
        ...
        print(motion_module_dropdown)
        print(prompt_textbox)
        print(negative_prompt_textbox)
        print(width_slider)
        print(height_slider)
        print(seed_textbox)
        ...
        # }
        return gr.Video(label="Generated Animation", interactive=False), gr.Json(label="Config", value=None)
        ...
        with gr.Row():
            with gr.Column():
                base_model_dropdown = gr.Dropdown(label="Base DreamBooth Model",
                                                  choices=["lyriel_v16.safetensors", "lyriel_v16.safetensors"],
                                                  value="lyriel_v16.safetensors", interactive=True)
                ...
                with gr.Accordion("Advance", open=False):
                    ...
                    with gr.Row():
                        ...
                        seed_button.click(fn=lambda: gr.Textbox.update(value=random.randint(1, 1e16)), inputs=[],
            ...
            inputs = [base_model_dropdown, motion_module_dropdown, prompt_textbox, negative_prompt_textbox,
